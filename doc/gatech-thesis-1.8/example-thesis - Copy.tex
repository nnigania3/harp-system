...
%%
\title{FPGA Protyping Of Custom GPGPUs} %% If you want to specify a linebreak
...
\copyrightyear{2013}
\submitdate{January 2013} % Must be the month and year of graduation,
