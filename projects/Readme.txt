...
********As mentioned earlier you can test many different configurations on board using this project******** Please refer to the 'system_build' document for more details.

=======================================================
Test options:

********Memory:
		- You can use DDR2 or a dummy memory as you want. If you want to use either use the flag 'DUMMY_MEM' by setting the macro. Where to set this in quartus is discussed in the system_build document. This can help to do quick tests or to do simple tests to check core,cache without DDR2. 
